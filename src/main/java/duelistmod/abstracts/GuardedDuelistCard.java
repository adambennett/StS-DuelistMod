...
public abstract class GuardedDuelistCard extends DuelistCard implements GuardedCard, HasGuardedState {

    private final GuardedState guarded = new GuardedState(0);

    public GuardedDuelistCard(String ID, String NAME, String IMG, int COST, String DESCRIPTION, CardType TYPE, CardColor COLOR, CardRarity RARITY, CardTarget TARGET) {
