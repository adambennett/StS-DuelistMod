...
public class MillenniumEye extends DuelistRelic implements MillenniumItem {
	...
	public void atBattleStart() 
	{
		if (!(AbstractDungeon.player.hasRelic(MillenniumSymbol.ID) && StartingDeck.currentDeck == StartingDeck.TOON))
		{
			...
			AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new ToonWorldPower(AbstractDungeon.player, AbstractDungeon.player)));
		}
		this.grayscale = true;
	}
