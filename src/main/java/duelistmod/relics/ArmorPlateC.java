...
public class ArmorPlateC extends DuelistRelic implements MillenniumArmorPlate {
	...
	// ID, images, text.
	public static final String ID = DuelistMod.makeID("ArmorPlateC");
	...
	private static int plateSize = 10;
