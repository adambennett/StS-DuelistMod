...
public class VolcanoToken extends DuelistRelic {

	public static final String ID = DuelistMod.makeID("VolcanoToken");
	...
	public boolean canSpawn() {
        return super.canSpawn() && Util.deckIs("Increment Deck");
	}
