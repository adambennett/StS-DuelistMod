...
public class ArmorPlateB extends DuelistRelic implements MillenniumArmorPlate {
	...
	// ID, images, text.
	public static final String ID = DuelistMod.makeID("ArmorPlateB");
	...
	private static int plateSize = 6;
