...
public class DuelistMenuScreen
{
    ...
    {
        try {
            Class<?> ModBadge = DuelistMenuScreen.class.getClassLoader().loadClass("basemod.ModBadge");
            ...
            Class<?> ModPanel = DuelistMenuScreen.class.getClassLoader().loadClass("basemod.ModPanel");
            ...
            BaseMod_modSettingsUp = DuelistMenuScreen.class.getClassLoader().loadClass("basemod.BaseMod").getDeclaredField("modSettingsUp");
    ...
    public void open()
    {
        ...
        CardCrawlGame.mainMenuScreen.screen = MainMenuPatchEnums.DUELIST_SCREEN;
