...
public class AgilityJuiceRare extends DuelistPotion {

    public static final String POTION_ID = DuelistMod.makeID("AgilityJuiceRare");
    ...
    public void use(AbstractCreature target) {
        DuelistCard.drawRare(this.potency, AbstractCard.CardRarity.RARE);
    }
