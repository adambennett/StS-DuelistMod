...
public class GiftPotion extends DuelistPotion {
    ...
    public GiftPotion() {
    	...
    	super(NAME, POTION_ID, PotionRarity.RARE, PotionSize.HEART, PotionEffect.OSCILLATE, Colors.GRAY, Colors.GRAY, Colors.PINK);
    ...
    public void use(AbstractCreature target) 
    {
    	...
    	DuelistCard.heal(AbstractDungeon.player, 4);
    }
    ...
    {
      this.potency += 2;
      this.description = DESCRIPTIONS[0] + this.potency + DESCRIPTIONS[1] + 6 + DESCRIPTIONS[2];
      this.tips.clear();
      this.tips.add(new PowerTip(this.name, this.description));
    }
}
