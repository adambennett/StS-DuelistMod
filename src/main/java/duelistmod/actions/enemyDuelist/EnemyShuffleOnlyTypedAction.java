...
public class EnemyShuffleOnlyTypedAction extends com.megacrit.cardcrawl.actions.AbstractGameAction {
	...
	public EnemyShuffleOnlyTypedAction(CardType tag, AnyDuelist duelist) {
	...
	public void update() {
		...
		if (taggedGroup.size() > 0) {
			this.duelist.discardPile().removeIf(ea -> ea.type.equals(tag));
