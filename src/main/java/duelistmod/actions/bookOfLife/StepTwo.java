	...
	public void update()
	{
		...
		if (this.duration == Settings.ACTION_DUR_MED)
		{
			...
			if (tmp.group.size() > 0)
			{
				...
				AbstractDungeon.gridSelectScreen.open(tmp, 1, "Book of Life - Step 2 - Choose how many cards will be Special Summoned by the custom card", false, false, false, false);
			}	
