...
public class HauntedRemovedAction extends AbstractGameAction
{
	...
	public HauntedRemovedAction(int amount, CardTags tag) 
	{
	...
	public HauntedRemovedAction(int amount, CardType tag) 
	{
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
		this.amount = amount;
		this.duration = 0.35F;
