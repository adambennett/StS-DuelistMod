...
public class MillenniumPrayerbookAction extends AbstractGameAction
{
	...
	public MillenniumPrayerbookAction(ArrayList<DuelistCard> cardsToChooseFrom, int amount)
	{
