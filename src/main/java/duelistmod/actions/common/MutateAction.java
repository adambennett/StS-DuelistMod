...
public class MutateAction extends AbstractGameAction
{
	...
	public MutateAction(int amtToMutate)
	{
	...
	public MutateAction(ArrayList<AbstractCard> toMutateFrom, int amtToMutate, int mutateOptions, boolean allowNonZombies)
	{
		this.p = AbstractDungeon.player;
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
		this.duration = Settings.ACTION_DUR_MED;
	...
	public MutateAction(ArrayList<AbstractCard> toMutateFrom, int amtToMutate, int mutateOptions, boolean allowNonZombies, boolean ghostrick)
	{
		this.p = AbstractDungeon.player;
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
		this.duration = Settings.ACTION_DUR_MED;
	...
	public MutateAction(ArrayList<AbstractCard> toMutateFrom, int amtToMutate, int mutateOptions, boolean allowNonZombies, boolean ghostrick, boolean vampire)
	{
		this.p = AbstractDungeon.player;
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
		this.duration = Settings.ACTION_DUR_MED;
	...
	public void update()
	{
		...
		if ((AbstractDungeon.gridSelectScreen.selectedCards.size() != 0))
		{
			...
			this.addToBot(new MutateStepTwo(ref, this.mutateOptions, mutateMap));
