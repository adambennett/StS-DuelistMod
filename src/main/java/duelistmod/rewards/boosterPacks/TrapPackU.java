...
public class TrapPackU extends BoosterPack
{

	public TrapPackU() {
		super("Trap Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.TRAP, 5, toRet, CardRarity.RARE));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new TrapPackU();
	}
