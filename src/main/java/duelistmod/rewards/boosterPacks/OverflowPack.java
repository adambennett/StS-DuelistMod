...
public class OverflowPack extends BoosterPack
{

	public OverflowPack() {
		super("Overflow Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.IS_OVERFLOW, 4, toRet, CardRarity.RARE));
