...
public class SkillPack extends BoosterPack
{

	public SkillPack() {
		super("Skill Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(CardType.SKILL, 4, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(CardType.SKILL, 1, toRet));
		return toRet;
	}
