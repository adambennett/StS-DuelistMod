...
public class ThalassicPack extends BoosterPack
{

	public ThalassicPack() {
		super("Thalassic Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.THALASSIC, 3, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(Tags.THALASSIC, 2, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new ThalassicPack();
	}
