...
public class PelagicPack extends BoosterPack
{

	public PelagicPack() {
		super("Pelagic Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.PELAGIC, 3, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(Tags.PELAGIC, 2, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new PelagicPack();
	}
