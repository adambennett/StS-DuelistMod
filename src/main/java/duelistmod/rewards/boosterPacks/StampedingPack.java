...
public class StampedingPack extends BoosterPack
{

	public StampedingPack() {
		super("Stampeding Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.STAMPEDING, 3, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(Tags.STAMPEDING, 2, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new StampedingPack();
	}
