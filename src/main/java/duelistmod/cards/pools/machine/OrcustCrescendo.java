...
public class OrcustCrescendo extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void onRetained() {
        this.upgradeSecondMagic(this.magicNumber);
    }
    ...
    {
    	this.addToBot(new SolderAction(this.secondMagic));
    	this.addToBot(new SolderAction(this.secondMagic));
    }
