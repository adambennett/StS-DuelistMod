...
public class Deskbot004 extends DuelistCard 
{
    // TEXT DECLARATION

    public static final String ID = DuelistMod.makeID("Deskbot004");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("Deskbot004.png");
    ...
    public Deskbot004() {
        ...
        this.baseMagicNumber = this.magicNumber = this.detonationCheckForSummonZones = 1;
