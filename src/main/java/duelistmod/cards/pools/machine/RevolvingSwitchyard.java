...
import duelistmod.powers.duelistPowers.RevolvingSwitchyardPower;
import duelistmod.variables.Tags;

public class RevolvingSwitchyard extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("RevolvingSwitchyard");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("RevolvingSwitchyard.png");
    ...
    {
    	applyPowerToSelf(new RevolvingSwitchyardPower());
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new RevolvingSwitchyard();
    }
