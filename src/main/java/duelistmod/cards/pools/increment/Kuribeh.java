...
public class Kuribeh extends DuelistCard {
    public static final String ID = DuelistMod.makeID("Kuribeh");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("Kuribeh.png");
