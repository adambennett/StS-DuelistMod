...
public class ShiranuiSmith extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	summon();
    	ArrayList<AbstractCard> list = findAllOfCardTypeForResummon(CardType.SKILL, this.magicNumber);
