...
public class ShiranuiSwordsaga extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	tribute();
    	ArrayList<AbstractCard> list = findAllOfCardTypeForResummon(CardType.ATTACK, this.magicNumber);
