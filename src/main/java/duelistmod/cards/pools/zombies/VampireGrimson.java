...
public class VampireGrimson extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	{
    		if (!c.uuid.equals(this.uuid) && c.hasTag(Tags.VAMPIRE)) { vampires++; }
    	}
