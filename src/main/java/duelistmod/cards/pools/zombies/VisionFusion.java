...
import duelistmod.actions.unique.VisionFusionAction;
import duelistmod.helpers.Util;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.powers.*;
import duelistmod.variables.Tags;

public class VisionFusion extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public VisionFusion() {
        ...
        this.baseThirdMagic = this.thirdMagic = 2;
    }
    ...
    {
    	this.addToBot(new VisionFusionAction(this.magicNumber, this.secondMagic, this.thirdMagic));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new VisionFusion();
    }
