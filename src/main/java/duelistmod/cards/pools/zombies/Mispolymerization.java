...
public class Mispolymerization extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	if (drawCards.size() > 0)
    	{
    		...
    		if (!rand.hasTag(Tags.ZOMBIE)) { damageSelf(this.secondMagic); }
    	}
    }
