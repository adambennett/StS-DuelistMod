...
public class ParallelWorldFusion extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	if (res.size() > 0)
    	{
    		AbstractCard rand = res.get(AbstractDungeon.cardRandomRng.random(res.size() - 1));
    		resummon(rand, m, this.magicNumber);
    	}
    }
    ...
    public AbstractCard makeCopy() {
        return new ParallelWorldFusion();
    }
