...
import duelistmod.actions.common.FetchAndReduceFromTagAction;
import duelistmod.helpers.Util;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.powers.*;
import duelistmod.variables.Tags;

public class CyberEmergency extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CyberEmergency");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("CyberEmergency.png");
    ...
    {
    	this.addToBot(new FetchAndReduceFromTagAction(1, p.drawPile, 0, this.magicNumber, true, Tags.MACHINE));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new CyberEmergency();
    }
