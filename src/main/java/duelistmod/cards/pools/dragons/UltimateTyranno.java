...
public class UltimateTyranno extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("UltimateTyranno");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("UltimateTyranno.png");
