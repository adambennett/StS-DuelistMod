...
public class SuperconductorTyranno extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("SuperconductorTyranno");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("SuperconductorTyranno.png");
    ...
    public AbstractCard makeCopy() {
        return new SuperconductorTyranno();
    }
