...
public class StampingDestruction extends DuelistCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	int maxDmgCap = 90 + this.magicNumber;
    	...
    	int dmgCap = 5;
    	if (AbstractDungeon.cardRandomRng.random(1, 6) == 1) { dmgCap += (this.magicNumber / 10); }
    	else if (AbstractDungeon.cardRandomRng.random(1, 6) == 1) { maxWeak += (this.magicNumber / 10); }
