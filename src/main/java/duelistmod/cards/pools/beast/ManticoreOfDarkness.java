...
import duelistmod.powers.duelistPowers.ManticoreOfDarknessPower;
...
public class ManticoreOfDarkness extends DuelistCard {
    ...
    public void duelistUseCard(AbstractCreature owner, List<AbstractCreature> targets) {
        ...
        duelist.applyPowerToSelf(new ManticoreOfDarknessPower(duelist.creature(), duelist.creature(), this.magicNumber));
