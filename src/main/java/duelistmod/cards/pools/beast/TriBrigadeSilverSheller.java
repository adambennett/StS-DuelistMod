...
import duelistmod.powers.duelistPowers.TriBrigadeSilverShellerPower;
...
public class TriBrigadeSilverSheller extends DuelistCard {
    ...
    public void duelistUseCard(AbstractCreature owner, List<AbstractCreature> targets) {
        ...
        duelist.applyPowerToSelf(new TriBrigadeSilverShellerPower(duelist.creature(), duelist.creature(), this.magicNumber));
    }
