...
import duelistmod.powers.duelistPowers.GishkiNoelliaPower;
import duelistmod.variables.Tags;

public class GishkiNoellia extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	summon();
    	applyPowerToSelf(new GishkiNoelliaPower(p, p, this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new GishkiNoellia();
    }
