...
public class BarrierStatue extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	AbstractCard rand = p.masterDeck.getRandomCard(true);
    	p.masterDeck.removeCard(rand);
    	AbstractDungeon.transformCard(rand, true, AbstractDungeon.miscRng);
