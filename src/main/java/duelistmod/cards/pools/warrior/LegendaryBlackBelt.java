...
public class LegendaryBlackBelt extends NimbleDuelistCard {
    ...
    public LegendaryBlackBelt() {
        ...
        this.baseMagicNumber = this.magicNumber = 6;  // vigor gain
    ...
    public void duelistUseCard(AbstractCreature owner, List<AbstractCreature> targets) {
        ...
        if (this.magicNumber > 0) {
            duelist.applyPowerToSelf(new VigorPower(duelist.creature(), this.magicNumber), duelist.creature());
        }
