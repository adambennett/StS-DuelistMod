...
import duelistmod.powers.warrior.CrystalTreePower;
...
public class CrystalTree extends DuelistCard {
    ...
    public void duelistUseCard(AbstractCreature owner, List<AbstractCreature> targets) {
        ...
        AnyDuelist.from(this).applyPowerToSelf(new CrystalTreePower(owner), owner);
        postDuelistUseCard(owner, targets);
    }

    @Override
    public AbstractCard makeCopy() { return new CrystalTree(); }
