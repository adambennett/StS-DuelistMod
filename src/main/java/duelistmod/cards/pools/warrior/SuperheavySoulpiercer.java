...
public class SuperheavySoulpiercer extends FirstStrikeDuelistCard {
    ...
    public void onFirstStrikeTriggered(AnyDuelist duelist, AbstractCreature target) {
        ...
        DamageInfo info = new DamageInfo(duelist.creature(), this.damage, DamageInfo.DamageType.HP_LOSS);
