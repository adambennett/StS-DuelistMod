...
public class GravityWarrior extends DuelistCard 
{
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	{ 
    		applyPowerToSelf(new StrengthPower(p, p.getPower(DexterityPower.POWER_ID).amount * 2)); 
    		applyPowerToSelf(new LoseStrengthPower(p, p.getPower(DexterityPower.POWER_ID).amount * 2)); 
    	}
    }
	...
	@Override
    public AbstractCard makeCopy() { return new GravityWarrior(); }
