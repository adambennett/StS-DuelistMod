...
public class CrystalOrbCard extends OrbCard
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CrystalOrbCard");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("CrystalOrbCard.png");
    ...
    {
    	AbstractOrb orb = new DuelistCrystal();
    	channel(orb);
    }
