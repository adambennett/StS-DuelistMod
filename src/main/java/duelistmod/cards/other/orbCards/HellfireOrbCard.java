...
public class HellfireOrbCard extends OrbCard
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("HellfireOrbCard");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("HellfireOrbCard.png");
    ...
    {
    	AbstractOrb orb = new DuelistHellfire();
    	channel(orb);
    }
