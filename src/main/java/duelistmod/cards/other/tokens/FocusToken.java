...
public class FocusToken extends TokenCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("FocusToken");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("Thousand_Eyes_Idol.png");
    ...
    public FocusToken(String tokenName) 
    { 
