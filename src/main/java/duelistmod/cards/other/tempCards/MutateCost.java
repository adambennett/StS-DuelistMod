...
public class MutateCost extends MutateCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("MutateCost");
    ...
    public MutateCost(int magic, CardRarity rarity) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new MutateCost(this.baseMagicNumber, this.rarity); }
