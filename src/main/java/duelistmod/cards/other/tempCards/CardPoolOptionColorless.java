...
public class CardPoolOptionColorless extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionColorless");
    ...
    public CardPoolOptionColorless() 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionColorless(); }
