...
public class CardPoolOptionBlack extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionBlack");
    ...
    public CardPoolOptionBlack() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = DuelistMod.isInfiniteSpire;
    }
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionBlack(); }
