...
public class CardPoolOptionSaveB extends TokenCard 
{
    // TEXT DECLARATION
    ...
    public void resetPool()
    {
    	...
    	try 
		{
			...
			config.setString(DuelistMod.PROP_SAVE_SLOT_B, DuelistMod.saveSlotB);
			config.save();
    ...
    private ArrayList<AbstractCard> setupPool()
	{
		...
		if (!DuelistMod.saveSlotB.equals(""))
		{
			String[] savedStrings = DuelistMod.saveSlotB.split("~");
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionSaveB(); }
