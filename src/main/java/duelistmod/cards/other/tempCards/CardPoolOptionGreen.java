...
public class CardPoolOptionGreen extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionGreen");
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionGreen(); }
