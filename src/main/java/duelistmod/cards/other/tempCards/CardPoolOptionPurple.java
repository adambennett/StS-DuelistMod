...
public class CardPoolOptionPurple extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionPurple");
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(BaseGameHelper.getAllWatcherCards());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionPurple(); }
