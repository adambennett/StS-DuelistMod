...
public class CardPoolOptionInsect extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionInsect");
    ...
    public CardPoolOptionInsect() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedInsectSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(InsectPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionInsect(); }
