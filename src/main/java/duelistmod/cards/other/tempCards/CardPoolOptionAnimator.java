...
import duelistmod.helpers.crossover.AnimatorHelper;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.relics.CardPoolRelic;
import duelistmod.variables.Strings;

public class CardPoolOptionAnimator extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionAnimator");
    ...
    public CardPoolOptionAnimator() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = DuelistMod.isAnimator;
    }
    ...
    public void loadPool()
    {
		...
		try {
			DuelistMod.toReplacePoolWith.addAll(AnimatorHelper.getAllCards());
		} catch (IllegalAccessException e) {
			Util.log("Illegal access exception was caught while attempting to add Animator cards to the pool");
		}
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionAnimator(); }
