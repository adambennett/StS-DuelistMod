...
public class CardPoolOptionNaturia extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionNaturia");
    ...
    public CardPoolOptionNaturia() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedNaturiaSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(NaturiaPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionNaturia(); }
