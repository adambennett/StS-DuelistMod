...
public class CardPoolOptionDisciple extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionDisciple(); }
