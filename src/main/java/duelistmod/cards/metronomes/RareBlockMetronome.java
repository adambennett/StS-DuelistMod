...
public class RareBlockMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
    ...
    public AbstractCard returnCard()
    {
		...
		for (DuelistCard c : DuelistMod.myCards) { if (c.baseBlock > 0 && !c.hasTag(Tags.NEVER_GENERATE) && allowResummonsWithExtraChecks(c) && !c.hasTag(Tags.NO_METRONOME) && c.rarity.equals(CardRarity.RARE)) { cardsToPullFrom.add((DuelistCard) c.makeCopy()); }}
