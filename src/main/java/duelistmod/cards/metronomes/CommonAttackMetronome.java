...
public class CommonAttackMetronome extends MetronomeCard {

    public static final String ID = DuelistMod.makeID("CommonAttackMetronome");
    ...
    public AbstractCard returnCard() {
        ...
        for (DuelistCard c : DuelistMod.myCards) {
            if (c.rarity.equals(CardRarity.COMMON) && c.type.equals(CardType.ATTACK) && !c.hasTag(Tags.NEVER_GENERATE) && allowResummonsWithExtraChecks(c) && !c.hasTag(Tags.NO_METRONOME)) {
