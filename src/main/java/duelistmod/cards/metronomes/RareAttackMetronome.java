...
public class RareAttackMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("RareAttackMetronome");
    ...
    public AbstractCard makeCopy() {
        return new RareAttackMetronome();
    }
