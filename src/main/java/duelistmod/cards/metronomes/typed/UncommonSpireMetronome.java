...
public class UncommonSpireMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
	...
	{
    	ArrayList<AbstractCard> tmp = findAllOfTypeForResummonSpire(CardRarity.UNCOMMON, this.magicNumber, false);
		return tmp;
	}
    ...
    public AbstractCard makeCopy() {
        return new UncommonSpireMetronome();
    }
