...
public class CommonSpireMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
	...
	{
		ArrayList<AbstractCard> tmp = findAllOfTypeForResummonSpire(CardRarity.COMMON, this.magicNumber, false);
		return tmp;
	}
    ...
    public AbstractCard makeCopy() {
        return new CommonSpireMetronome();
    }
