...
public class SpireMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
	...
	{
    	ArrayList<AbstractCard> tmp = findAllOfTypeForResummonSpire(null, this.magicNumber, false);
		return tmp;
	}
