...
public class UncommonMonsterMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
    ...
    public UncommonMonsterMetronome() {
	...
	{
		ArrayList<AbstractCard> tmp = findAllOfTypeForResummonMetronome(this.resTag, null, CardRarity.UNCOMMON, this.magicNumber);
		return tmp;
	}
    ...
    public AbstractCard makeCopy() {
        return new UncommonMonsterMetronome();
    }
