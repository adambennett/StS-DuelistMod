...
public class RareSpireMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
	...
	{
    	ArrayList<AbstractCard> tmp = findAllOfTypeForResummonSpire(CardRarity.RARE, this.magicNumber, false);
		return tmp;
	}
