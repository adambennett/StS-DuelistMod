...
public class RevengeMetronome extends MetronomeCard {

    public static final String ID = DuelistMod.makeID("RevengeMetronome");
    ...
    public AbstractCard returnCard() {
		...
		for (DuelistCard c : DuelistMod.myCards) {
            if (c instanceof RevengeCard && !c.hasTag(Tags.NEVER_GENERATE) && allowResummonsWithExtraChecks(c) && !c.hasTag(Tags.NO_METRONOME) && !c.rarity.equals(CardRarity.SPECIAL) && !c.rarity.equals(CardRarity.BASIC)) {
