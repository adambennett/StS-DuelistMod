...
public class TripodFishPower extends AbstractPower implements IShufflePower
{
	...
	public static final String IMG = DuelistMod.makePowerPath("TripodFishPower.png");
	private boolean finished = false;
	
	public TripodFishPower(final AbstractCreature owner, final AbstractCreature source, int amount) 
	{
		this.name = NAME;
		this.ID = POWER_ID;
		this.owner = owner;
