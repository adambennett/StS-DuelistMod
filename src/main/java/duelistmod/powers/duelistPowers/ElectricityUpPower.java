...
public class ElectricityUpPower extends DuelistPower 
{
	...
	public static final String POWER_ID = DuelistMod.makeID("ElectricityUpPower");
	private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
	public static final String NAME = powerStrings.NAME;
	public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
	public static final String IMG = DuelistMod.makePowerPath("ElectricityUpPower.png");
	...
	{
		if (this.amount2 < 1) { DuelistCard.removePower(this, this.owner); DuelistCard.applyPower(new ElectricityPower(this.owner, this.owner, -this.amount), this.owner); }
		else
		{
			this.amount2--;
			if (this.amount2 < 1) { DuelistCard.removePower(this, this.owner); DuelistCard.applyPower(new ElectricityPower(this.owner, this.owner, -this.amount), this.owner); }
