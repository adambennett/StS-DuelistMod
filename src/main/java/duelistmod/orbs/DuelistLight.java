...
public class DuelistLight extends DuelistOrb {
    ...
    public void onEvoke() {
		...
		if (this.owner.player()) {
			DuelistCard.gainTempHP(this.evokeAmount);
		} else {
			DuelistCard.gainTempHP(this.owner.getEnemy(), this.owner.getEnemy(), this.evokeAmount);
		}
    }
    ...
    public void triggerPassiveEffect() {
        ...
        if (this.passiveAmount > 0) {
			...
			if (this.owner.player()) {
				...
				DuelistCard.gainTempHP(this.owner.getEnemy(), this.owner.getEnemy(), this.passiveAmount);
			}
		}
    }
