...
public class PotionConfigData {
    ...
    public PotionConfigData(Boolean isDisabled, Integer magic) {
        this(isDisabled, magic, 0, 0, 0, "", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), null);
    }

    public PotionConfigData(Boolean isDisabled, Integer magic, Integer strengthLoss) {
        this(isDisabled, magic, 0, 0, strengthLoss, "", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), null);
    }

    public PotionConfigData(Boolean isDisabled, Integer magic, Integer effect, Integer misc, Integer strengthLoss, String text, String color, List<String> data, List<Integer> nums, List<Boolean> flags, Object other) {
