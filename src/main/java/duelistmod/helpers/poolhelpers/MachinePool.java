...
public class MachinePool {
    ...
    public static ArrayList<AbstractCard> oneRandom() {
        return new ArrayList<>(GlobalPoolHelper.oneRandom(4));
    }

    public static ArrayList<AbstractCard> twoRandom() {
        return new ArrayList<>(GlobalPoolHelper.twoRandom(4));
    }

    public static ArrayList<AbstractCard> deck() {

        ArrayList<AbstractCard> machineCards = new ArrayList<>();
        ...
        machineCards.add(new CyberPhoenix());
        machineCards.add(new JunkGiant());
    ...
    public static ArrayList<AbstractCard> basic() {
        ...
        if (DuelistMod.persistentDuelistData.CardPoolSettings.getSmallBasicSet()) {
            pool.addAll(BasicPool.smallBasic("Machine Deck"));
        } else {
            pool.addAll(BasicPool.fullBasic("Machine Deck"));
        }
        return pool;
    }
}
