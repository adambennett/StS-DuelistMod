...
public class RandomOrbHelperDualMod 
{
	...
	public static void resetOrbStringMap()
	{
		...
		DuelistMod.invertStringMap.put(new Shadow().name, new Plasma());
		DuelistMod.invertStringMap.put(new Plasma().name, new Shadow());
		...
		DuelistMod.invertStringMap.put(new DuelistLight().name, new Dark());
		DuelistMod.invertStringMap.put(new Dark().name, new DuelistLight());
