...
import duelistmod.cards.holiday.birthday.BalloonParty;
import duelistmod.cards.holiday.birthday.CocoonParty;
import duelistmod.cards.holiday.birthday.DinnerParty;
import duelistmod.cards.holiday.christmas.ElephantGift;
import duelistmod.cards.holiday.christmas.FairyGift;
import duelistmod.cards.holiday.christmas.GiftCard;
import duelistmod.cards.holiday.christmas.HeroicGift;
import duelistmod.cards.holiday.fourtwenty.WeedOut;
import duelistmod.cards.holiday.halloween.Hallohallo;
import duelistmod.cards.holiday.halloween.HalloweenManor;
import duelistmod.cards.holiday.halloween.PumpkinCarriage;
...
import duelistmod.cards.other.tokens.ZombieCorpse;
import duelistmod.cards.pools.dragons.AtomicScrapDragon;
import duelistmod.cards.pools.dragons.CyberEndDragon;
import duelistmod.cards.pools.dragons.Gandora;
import duelistmod.cards.pools.dragons.GenesisDragon;
...
public class Util
{
	...
	public static void setupDuelistTombRelics()
	{
		...
		DuelistMod.duelistRelicsForTombEvent.add(new AmuletOfGlory());
		DuelistMod.duelistRelicsForTombEvent.add(new CombatBracelet());
		DuelistMod.duelistRelicsForTombEvent.add(new GracefulCape());
		DuelistMod.duelistRelicsForTombEvent.add(new ObsidianCape());
		DuelistMod.duelistRelicsForTombEvent.add(new RegenBracelet());
		DuelistMod.duelistRelicsForTombEvent.add(new RingOfEndurance());
		DuelistMod.duelistRelicsForTombEvent.add(new RingOfRecoil());
		DuelistMod.duelistRelicsForTombEvent.add(new RingOfStone());
		DuelistMod.duelistRelicsForTombEvent.add(new WarriorRing());
	...
	public static void registerCustomPowers()
	{
		...
		BaseMod.addPower(AlphaMagnetPower.class, AlphaMagnetPower.POWER_ID);
		...
		BaseMod.addPower(BetaMagnetPower.class, BetaMagnetPower.POWER_ID);
		...
		BaseMod.addPower(GammaMagnetPower.class, GammaMagnetPower.POWER_ID);
		...
		BaseMod.addPower(BattleguardHowlingPower.class, BattleguardHowlingPower.POWER_ID);
		BaseMod.addPower(BrilliantSparkPower.class, BrilliantSparkPower.POWER_ID);
		BaseMod.addPower(CombinationAttackPower.class, CombinationAttackPower.POWER_ID);
		BaseMod.addPower(CrystalTreePower.class, CrystalTreePower.POWER_ID);
		BaseMod.addPower(CubicKarmaPower.class, CubicKarmaPower.POWER_ID);
		BaseMod.addPower(DarkOccultismPower.class, DarkOccultismPower.POWER_ID);
		BaseMod.addPower(LightLaserPower.class, LightLaserPower.POWER_ID);
		BaseMod.addPower(DeltaMagnetPower.class, DeltaMagnetPower.POWER_ID);
		BaseMod.addPower(DownbeatPower.class, DownbeatPower.POWER_ID);
		BaseMod.addPower(EgoBoostPower.class, EgoBoostPower.POWER_ID);
		BaseMod.addPower(EpsilonMagnetPower.class, EpsilonMagnetPower.POWER_ID);
		BaseMod.addPower(HarmonicWavesPower.class, HarmonicWavesPower.POWER_ID);
		...
		BaseMod.addPower(SuperheavyWagonPower.class, SuperheavyWagonPower.POWER_ID);
		BaseMod.addPower(AdvanceForcePower.class, AdvanceForcePower.POWER_ID);
