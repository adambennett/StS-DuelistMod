...
public class PrayerPageB extends DuelistRelic {
	...
	// ID, images, text.
	public static final String ID = DuelistMod.makeID("PrayerPageB");
	public static final String IMG =  DuelistMod.makeRelicPath("PrayerPageB.png");
