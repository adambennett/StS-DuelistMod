...
public class CardRewardRelicF extends CustomRelic
{
    ...
    public CardRewardRelicF() { super(ID, new Texture(IMG), new Texture(OUTLINE), RelicTier.SHOP, LandingSound.MAGICAL); this.dcss = new DuelistCardSelectScreen(true);}
    ...
    public void onEquip()
    {
		...
		((DuelistCardSelectScreen)AbstractDungeon.gridSelectScreen).open(group, 1, "Select a Spell to add to your deck");
