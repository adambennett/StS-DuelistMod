...
public class GeartownPower extends DuelistPower
{	
	public AbstractCreature source;

    public static final String POWER_ID = DuelistMod.makeID("GeartownPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String IMG = DuelistMod.makePowerPath("PlaceholderPower.png");
	
	public GeartownPower(int amt) 
	{ 
		this(AbstractDungeon.player, AbstractDungeon.player, amt);
	}
	
	public GeartownPower(AbstractCreature source, AbstractCreature owner, int amt) 
	{ 
		this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;        
