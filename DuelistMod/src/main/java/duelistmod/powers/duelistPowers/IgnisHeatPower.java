...
{	
    ...
    public static final String IMG = DuelistMod.makePowerPath("IgnisHeatPower.png");
	...
	public void atEndOfTurn(final boolean isPlayer) 
	{
		if (this.amount > 0) 
		{
			AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(new Burn(), this.amount, true, true));
		}
	}
