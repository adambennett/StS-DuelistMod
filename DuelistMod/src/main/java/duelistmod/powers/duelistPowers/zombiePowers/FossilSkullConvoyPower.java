...
public class FossilSkullConvoyPower extends DuelistPower
{	
	...
	public FossilSkullConvoyPower(int turns) 
	{ 
		this(AbstractDungeon.player, AbstractDungeon.player, turns);
	}
	
	public FossilSkullConvoyPower(AbstractCreature owner, AbstractCreature source, int stacks) 
	{ 
