...
public class ZombiePowerStrugglePower extends DuelistPower
{	
	...
	public ZombiePowerStrugglePower(int turns) 
	{ 
		this(AbstractDungeon.player, AbstractDungeon.player, turns);
	}
	
	public ZombiePowerStrugglePower(AbstractCreature owner, AbstractCreature source, int stacks) 
	{ 
