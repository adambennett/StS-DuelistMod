...
public class SupersonicSkullFlamePower extends DuelistPower
{	
	...
	public SupersonicSkullFlamePower(int turns) 
	{ 
		this(AbstractDungeon.player, AbstractDungeon.player, turns);
	}
	
	public SupersonicSkullFlamePower(AbstractCreature owner, AbstractCreature source, int stacks) 
	{ 
