...
public class KaibaA3 extends DuelistMonster
{
	
	public static final String ID = DuelistMod.makeID("KaibaA3"); // Monster ID (remember the prefix - yourModID:DefaultMonster)
	...
	private DuelistCard stardust;
	private DuelistCard fiveheaded;
	private DuelistCard busterblader;
