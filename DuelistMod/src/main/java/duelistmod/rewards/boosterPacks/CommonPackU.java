...
public class CommonPackU extends BoosterPack
{

	public CommonPackU() {
		super("Common Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(CardType.SKILL, 2, toRet, CardRarity.RARE, CardRarity.UNCOMMON));
