...
public class PowerPackR extends BoosterPack
{

	public PowerPackR() {
		super("Power Pack", "RareBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(CardType.POWER, 3, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(CardType.POWER, 2, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new PowerPackR();
	}
