...
public class RecklessPack extends BoosterPack
{

	public RecklessPack() {
		super("Reckless Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.RECKLESS, 3, toRet, CardRarity.RARE));
		toRet.addAll(this.findAllCards(Tags.RECKLESS, 2, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new RecklessPack();
	}
