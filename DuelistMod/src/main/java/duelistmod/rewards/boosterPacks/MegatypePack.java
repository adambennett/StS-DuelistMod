...
public class MegatypePack extends BoosterPack
{

	public MegatypePack() {
		super("Megatype Pack", "AllRaresBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.MEGATYPED, 5, toRet));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new MegatypePack();
	}
