...
public class PlayedMonstersPack extends BoosterPack
{

	public PlayedMonstersPack() {
		super("Played Monsters Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		ss.addAll(DuelistMod.uniqueMonstersThisRun);
