...
public class DragonPack extends BoosterPack
{

	public DragonPack() {
		super("Dragon Pack", "UncommonBooster");
	...
	public ArrayList<AbstractCard> getCards()
	{
		...
		toRet.addAll(this.findAllCards(Tags.DRAGON, 5, toRet, CardRarity.RARE));
		return toRet;
	}

	@Override
	public BoosterPack makeCopy() {
		return new DragonPack();
	}
