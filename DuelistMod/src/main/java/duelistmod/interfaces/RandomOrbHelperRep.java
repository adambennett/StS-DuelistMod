...
public class RandomOrbHelperRep 
{
	...
	public static void resetOrbStringMap()
	{
		...
		DuelistMod.invertStringMap.put(new FireOrb().name, new Splash());		
		DuelistMod.invertStringMap.put(new Splash().name, new HellFireOrb());
		DuelistMod.invertStringMap.put(new HellFireOrb().name, new Splash());		
		...
		DuelistMod.invertStringMap.put(new Shadow().name, new ReplayLightOrb());
		DuelistMod.invertStringMap.put(new ReplayLightOrb().name, new Shadow());		
		DuelistMod.invertStringMap.put(new GlassOrb().name, new Sand());
		DuelistMod.invertStringMap.put(new Sand().name, new GlassOrb());		
		...
		DuelistMod.invertStringMap.put(new CrystalOrb().name, new MillenniumOrb(2));
		DuelistMod.invertStringMap.put(new MillenniumOrb(2).name, new CrystalOrb());		
