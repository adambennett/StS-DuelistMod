...
public class RandomOrbHelper
{
	...
	public static void resetOrbStringMap()
	{
		...
		DuelistMod.invertStringMap.put(new Splash().name, new FireOrb());
		...
		DuelistMod.invertStringMap.put(new Shadow().name, new MillenniumOrb());
		DuelistMod.invertStringMap.put(new MillenniumOrb().name, new Shadow());		
