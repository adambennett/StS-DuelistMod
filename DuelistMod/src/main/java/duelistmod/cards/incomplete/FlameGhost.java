...
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("FlameGhost");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("FlameGhost.png");
	...
	{
		DuelistCard.staticAttack(AbstractDungeon.getRandomMonster(), this.baseAFX, this.magicNumber);
	}
