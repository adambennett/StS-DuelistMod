...
public class WitchBlackRose extends DuelistCard 
{
    // TEXT DECLARATION

    public static final String ID = DuelistMod.makeID("WitchBlackRose");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("WitchBlackRose.png");
