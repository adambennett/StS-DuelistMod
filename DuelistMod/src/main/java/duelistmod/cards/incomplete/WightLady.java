...
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("WightLady");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("WightLady.png");
	...
	@Override
    public AbstractCard makeCopy() { return new WightLady(); }
