...
public class PainPainter extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("PainPainter");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("PainPainter.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
		...
		// Discard randomly (not randomly)
		DuelistCard.discard(1, !upgraded);
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new PainPainter();
    }
