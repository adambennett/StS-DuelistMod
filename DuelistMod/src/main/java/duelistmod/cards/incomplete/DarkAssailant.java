...
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("DarkAssailant");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("DarkAssailant.png");
	...
	@Override
    public AbstractCard makeCopy() { return new DarkAssailant(); }
