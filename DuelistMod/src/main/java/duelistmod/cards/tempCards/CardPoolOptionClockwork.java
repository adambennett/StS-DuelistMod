...
import duelistmod.helpers.crossover.ClockworkHelper;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.relics.CardPoolRelic;
import duelistmod.variables.Strings;

public class CardPoolOptionClockwork extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionClockwork");
    ...
    public CardPoolOptionClockwork() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = DuelistMod.isClockwork;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(ClockworkHelper.getAllCards());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionClockwork(); }
