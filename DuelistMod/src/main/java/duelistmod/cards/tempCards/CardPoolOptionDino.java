...
import duelistmod.helpers.poolhelpers.DinosaurPool;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.relics.CardPoolRelic;
import duelistmod.variables.Strings;

public class CardPoolOptionDino extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionDino");
    ...
    public CardPoolOptionDino() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedDinoSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(DinosaurPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionDino(); }
