...
public class VineBlockCard extends TokenCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("VineBlockCard");
    ...
    public VineBlockCard(int magic) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new VineBlockCard(this.magicNumber); }
