...
public class CardPoolOptionStandard extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionStandard");
    ...
    public CardPoolOptionStandard() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedStandardSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(StandardPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionStandard(); }
