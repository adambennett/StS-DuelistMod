...
public class ZombieDrawTypeCard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public ZombieDrawTypeCard(int magic) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new ZombieDrawTypeCard(this.magicNumber); }   
