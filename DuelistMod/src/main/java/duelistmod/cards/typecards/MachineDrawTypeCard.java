...
public class MachineDrawTypeCard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public MachineDrawTypeCard(int magic) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new MachineDrawTypeCard(this.magicNumber); }   
