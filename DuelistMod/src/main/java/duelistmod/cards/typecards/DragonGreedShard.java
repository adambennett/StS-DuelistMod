...
public class DragonGreedShard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public DragonGreedShard(int magic) 
    { 
    ...
    {
    	applyPowerToSelf(new GreedShardPower(p, p, this.magicNumber, Tags.DRAGON));
    }   
