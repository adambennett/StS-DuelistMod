...
public class SpellcasterTypeCard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public SpellcasterTypeCard(String tokenName) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new SpellcasterTypeCard(); }   
    @Override public void use(AbstractPlayer p, AbstractMonster m)  
    {
    	applyPowerToSelf(new RainbowCapturePower(p, p, Tags.SPELLCASTER));
    }      
