...
public class NaturiaTypeCard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public NaturiaTypeCard(String tokenName) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new NaturiaTypeCard(); }   
    @Override public void use(AbstractPlayer p, AbstractMonster m)  
    {
    	applyPowerToSelf(new RainbowCapturePower(p, p, Tags.NATURIA));
    }   
