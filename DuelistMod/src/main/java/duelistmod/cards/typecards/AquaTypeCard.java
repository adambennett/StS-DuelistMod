...
public class AquaTypeCard extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("AquaTypeCard");
    ...
    public AquaTypeCard(String tokenName) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new AquaTypeCard(); }   
    @Override public void use(AbstractPlayer p, AbstractMonster m)  
    {
    	applyPowerToSelf(new RainbowCapturePower(p, p, Tags.AQUA));
    }   
