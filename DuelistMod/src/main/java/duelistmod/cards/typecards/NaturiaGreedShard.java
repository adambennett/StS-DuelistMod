...
public class NaturiaGreedShard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public NaturiaGreedShard(int magic) 
    { 
    ...
    {
    	applyPowerToSelf(new GreedShardPower(p, p, this.magicNumber, Tags.NATURIA));
    }   
