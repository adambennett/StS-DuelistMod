...
public class ToonGreedShard extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public ToonGreedShard(int magic) 
    { 
    ...
    @Override public AbstractCard makeCopy() { return new ToonGreedShard(1); }   
    @Override public void use(AbstractPlayer p, AbstractMonster m)  
    {
    	applyPowerToSelf(new GreedShardPower(p, p, this.magicNumber, Tags.TOON));
    }      
