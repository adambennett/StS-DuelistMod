...
public class UltraPolymerization extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("UltraPolymerization");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("UltraPolymerization.png");
    ...
    {
        return new UltraPolymerization();
    }
