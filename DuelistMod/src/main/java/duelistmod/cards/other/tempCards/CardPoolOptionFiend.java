...
public class CardPoolOptionFiend extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionFiend");
    ...
    public CardPoolOptionFiend() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedFiendSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(FiendPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionFiend(); }
