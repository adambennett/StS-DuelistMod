...
public class CardPoolOptionSaveA extends TokenCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionSaveA");
    ...
    public void resetPool()
    {
    	...
    	DuelistMod.saveSlotA = "";
    	try 
		{
			SpireConfig config = new SpireConfig("TheDuelist", "DuelistConfig",DuelistMod.duelistDefaults);
			config.setString(DuelistMod.PROP_SAVE_SLOT_A, DuelistMod.saveSlotA);
			config.save();
    ...
    public void setPool(ArrayList<AbstractCard> newPool)
    {
    	...
    	this.magicNumber = this.baseMagicNumber = this.savedPool.size();
    	DuelistMod.saveSlotA = "";
    	for (AbstractCard c : this.savedPool) { DuelistMod.saveSlotA += c.originalName + "~"; }
    	try 
		{
			SpireConfig config = new SpireConfig("TheDuelist", "DuelistConfig",DuelistMod.duelistDefaults);
			config.setString(DuelistMod.PROP_SAVE_SLOT_A, DuelistMod.saveSlotA);
    ...
    private ArrayList<AbstractCard> setupPool()
	{
		...
		if (!DuelistMod.saveSlotA.equals(""))
		{
			String[] savedStrings = DuelistMod.saveSlotA.split("~");
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionSaveA(); }
