...
import duelistmod.helpers.crossover.HubrisHelper;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.relics.CardPoolRelic;
import duelistmod.variables.Strings;

public class CardPoolOptionHubris extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionHubris");
    ...
    public CardPoolOptionHubris() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = DuelistMod.isHubris;
    }
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionHubris(); }
