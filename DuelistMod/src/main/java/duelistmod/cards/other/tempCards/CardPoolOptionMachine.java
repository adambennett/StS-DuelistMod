...
public class CardPoolOptionMachine extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionMachine");
    ...
    public CardPoolOptionMachine() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedMachineSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(MachinePool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionMachine(); }
