...
public class CardPoolOptionRed extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionRed");
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(BaseGameHelper.getAllIroncladCards());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionRed(); }
