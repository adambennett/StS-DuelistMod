...
public class CardPoolOptionSpellcaster extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionSpellcaster");
    ...
    public CardPoolOptionSpellcaster() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedSpellcasterSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(SpellcasterPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionSpellcaster(); }
