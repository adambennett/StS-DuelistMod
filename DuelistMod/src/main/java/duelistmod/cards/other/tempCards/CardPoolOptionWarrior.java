...
public class CardPoolOptionWarrior extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionWarrior");
    ...
    public CardPoolOptionWarrior() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedWarriorSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(WarriorPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionWarrior(); }
