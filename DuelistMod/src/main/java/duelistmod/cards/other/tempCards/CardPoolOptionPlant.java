...
public class CardPoolOptionPlant extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionPlant");
    ...
    public CardPoolOptionPlant() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedPlantSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(PlantPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionPlant(); }
