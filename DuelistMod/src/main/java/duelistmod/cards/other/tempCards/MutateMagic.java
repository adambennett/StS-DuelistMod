...
import duelistmod.actions.common.MutateMagicNumAction;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.variables.Strings;

public class MutateMagic extends MutateCard 
{
    // TEXT DECLARATION
    ...
    public MutateMagic(int magic, CardRarity rarity) 
    { 
    ...
    {
    	this.addToBot(new MutateMagicNumAction(c, this.magicNumber));
    }
    ...
    @Override public AbstractCard makeCopy() { return new MutateMagic(this.baseMagicNumber, this.rarity); }
