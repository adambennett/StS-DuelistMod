...
public class CardPoolOptionOjama extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionOjama");
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionOjama(); }
