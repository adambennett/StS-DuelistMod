...
public class CardPoolOptionAqua extends CardPoolOptionTypeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CardPoolOptionAqua");
    ...
    public CardPoolOptionAqua() 
    { 
    	super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET); 
    	this.dontTriggerOnUseCard = true;
    	this.canAdd = !DuelistMod.addedAquaSet;
    }
    ...
    public void loadPool()
    {
		...
		DuelistMod.toReplacePoolWith.addAll(AquaPool.deck());
    ...
    @Override public AbstractCard makeCopy() { return new CardPoolOptionAqua(); }
