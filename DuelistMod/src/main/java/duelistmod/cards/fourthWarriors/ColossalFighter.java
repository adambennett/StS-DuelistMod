...
public class ColossalFighter extends DuelistCard 
{
    ...
    public static final String IMG = DuelistMod.makeCardPath("ColossalFighter.png");
	...
	@Override
    public AbstractCard makeCopy() { return new ColossalFighter(); }
