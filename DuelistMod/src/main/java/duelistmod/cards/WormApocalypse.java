...
public class WormApocalypse extends DuelistCard 
{
    // TEXT DECLARATION

    public static final String ID = DuelistMod.makeID("WormApocalypse");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("WormApocalypse.png");
