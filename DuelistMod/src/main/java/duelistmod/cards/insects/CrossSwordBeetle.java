...
public class CrossSwordBeetle extends DuelistCard 
{
    ...
    public static final String ID = DuelistMod.makeID("CrossSwordBeetle");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("CrossSwordBeetle.png");
