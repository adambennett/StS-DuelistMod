...
public class ArmedDragon3 extends ArmedDragonCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("ArmedDragon3");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("ArmedDragon3.png");
