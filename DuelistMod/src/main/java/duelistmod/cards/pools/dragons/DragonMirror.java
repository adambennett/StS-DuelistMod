...
import duelistmod.powers.duelistPowers.DragonMirrorPower;
import duelistmod.variables.Tags;

public class DragonMirror extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("DragonMirror");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("DragonMirror.png");
    ...
    {
    	applyPowerToSelf(new DragonMirrorPower(1));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new DragonMirror();
    }
