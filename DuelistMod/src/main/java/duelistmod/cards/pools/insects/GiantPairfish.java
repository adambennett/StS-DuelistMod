...
public class GiantPairfish extends DuelistCard 
{
    ...
    public GiantPairfish() {
        ...
        this.tributes = this.baseTributes = 15;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	if (this.tributes == 0)
    	{
    		AbstractDungeon.actionManager.addToBottom(new ModifyTributeAction(this, 15 - this.tributes, true));
    		this.rawDescription = this.originalDescription;
    		this.initializeDescription();    		
    	}
    	else if (this.tributes != 15)
    	{
    		AbstractDungeon.actionManager.addToBottom(new ModifyTributeAction(this, 15 - this.tributes, true));
    	}
    }
