...
public class HeavyMechSupportArmor extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("HeavyMechSupportArmor");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("HeavyMechSupportArmor.png");
    ...
    public AbstractCard makeCopy() {
        return new HeavyMechSupportArmor();
    }
