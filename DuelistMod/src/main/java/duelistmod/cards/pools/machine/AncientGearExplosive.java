...
public class AncientGearExplosive extends DuelistCard 
{
    // TEXT DECLARATION

    public static final String ID = DuelistMod.makeID("AncientGearExplosive");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("AncientGearExplosive.png");
    ...
    public AbstractCard makeCopy() {
        return new AncientGearExplosive();
    }
