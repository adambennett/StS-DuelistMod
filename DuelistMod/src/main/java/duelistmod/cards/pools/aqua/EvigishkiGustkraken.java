...
public class EvigishkiGustkraken extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    { 
    	super.onOverflowWhileSummoned();
    	AbstractMonster mon = AbstractDungeon.getRandomMonster();
    	if (mon != null) { this.thornAttack(mon, this.magicNumber); }
    }
    ...
    public AbstractCard makeCopy() {
        return new EvigishkiGustkraken();
    }
