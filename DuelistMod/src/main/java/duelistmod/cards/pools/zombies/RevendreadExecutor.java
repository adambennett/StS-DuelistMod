...
import duelistmod.actions.unique.RevendreadExecutorAction;
...
public class RevendreadExecutor extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	tribute();
    	attack(m);
    	this.addToBot(new RevendreadExecutorAction(m));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new RevendreadExecutor();
    }
