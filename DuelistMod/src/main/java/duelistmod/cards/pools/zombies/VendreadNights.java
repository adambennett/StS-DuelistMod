...
import duelistmod.powers.duelistPowers.zombiePowers.NoResummoningSkillsPower;
import duelistmod.variables.Tags;

public class VendreadNights extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	attack(m);
    	block();
    	applyPowerToSelf(new NoResummoningSkillsPower(p, p, this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new VendreadNights();
    }
