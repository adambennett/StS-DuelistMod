...
import duelistmod.powers.duelistPowers.zombiePowers.GhostrickBreakPower;
import duelistmod.variables.Tags;

public class GhostrickBreak extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	applyPowerToSelf(new GhostrickBreakPower(this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new GhostrickBreak();
    }
