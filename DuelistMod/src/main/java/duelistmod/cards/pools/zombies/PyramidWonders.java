...
import duelistmod.powers.duelistPowers.zombiePowers.PyramidWondersPower;
import duelistmod.variables.Tags;

public class PyramidWonders extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	applyPowerToSelf(new PyramidWondersPower(1));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new PyramidWonders();
    }
