...
import duelistmod.actions.unique.FossilSkullbuggyAction;
import duelistmod.helpers.Util;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.powers.*;
import duelistmod.variables.Tags;

public class FossilSkullbuggy extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	summon();
    	this.addToBot(new FossilSkullbuggyAction(this.magicNumber, this.secondMagic));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new FossilSkullbuggy();
    }
