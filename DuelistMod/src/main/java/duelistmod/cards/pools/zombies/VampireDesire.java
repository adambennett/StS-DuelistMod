...
public class VampireDesire extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	evokeAll();
    	if (DuelistMod.playedVampireThisTurn) { channelBottom(new Shadow()); } 
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new VampireDesire();
    }
