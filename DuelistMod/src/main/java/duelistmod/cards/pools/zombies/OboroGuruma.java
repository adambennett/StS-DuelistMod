...
import duelistmod.powers.duelistPowers.zombiePowers.OboroGurumaPower;
import duelistmod.variables.Tags;

public class OboroGuruma extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	summon();
    	applyPowerToSelf(new OboroGurumaPower(this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new OboroGuruma();
    }
