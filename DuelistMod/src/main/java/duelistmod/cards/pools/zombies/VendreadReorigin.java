...
public class VendreadReorigin extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	int amt = DuelistMod.entombedCardsCombat.size();
    	ArrayList<AbstractCard> list = DuelistCard.findAllOfTypeForResummon(Tags.VENDREAD, amt);
