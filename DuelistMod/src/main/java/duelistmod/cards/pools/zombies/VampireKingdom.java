...
import duelistmod.powers.duelistPowers.zombiePowers.VampireKingdomPower;
import duelistmod.variables.Tags;

public class VampireKingdom extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	applyPowerToSelf(new VampireKingdomPower(this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new VampireKingdom();
    }
