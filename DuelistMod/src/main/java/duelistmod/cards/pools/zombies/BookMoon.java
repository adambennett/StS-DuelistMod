...
import duelistmod.powers.duelistPowers.zombiePowers.BookMoonPower;
import duelistmod.variables.Tags;

public class BookMoon extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	applyPowerToSelf(new BookMoonPower(this.magicNumber));
    }
