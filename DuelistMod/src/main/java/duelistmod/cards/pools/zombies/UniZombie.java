...
import duelistmod.actions.unique.UniZombieAction;
import duelistmod.helpers.Util;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.powers.*;
import duelistmod.variables.Tags;

public class UniZombie extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	summon();
    	this.addToBot(new UniZombieAction(m, this.damage, this.block, this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new UniZombie();
    }
