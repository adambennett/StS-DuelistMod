...
public class DecayedCommander extends DuelistCard 
{
    // TEXT DECLARATION
	...
	public float calculateModifiedCardDamage(AbstractPlayer player, AbstractMonster mo, float tmp)
	{
    	...
    	{
    		int boost = TheDuelist.resummonPile.group.size() * this.magicNumber;
    		if (boost > 0) { tmp += boost; }
    	}
    	return tmp;
	}
