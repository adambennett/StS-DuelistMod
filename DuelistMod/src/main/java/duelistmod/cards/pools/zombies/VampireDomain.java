...
import duelistmod.powers.duelistPowers.zombiePowers.VampireDomainPower;
import duelistmod.variables.Tags;

public class VampireDomain extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	applyPowerToSelf(new VampireDomainPower());
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new VampireDomain();
    }
