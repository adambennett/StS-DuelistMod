...
import duelistmod.actions.unique.VampireDragonAction;
...
public class VampireDragon extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	tribute();
    	this.addToBot(new VampireDragonAction(p, this.multiDamage, this.damageTypeForTurn, AbstractGameAction.AttackEffect.NONE));
    }
