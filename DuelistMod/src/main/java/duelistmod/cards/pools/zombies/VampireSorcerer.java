...
public class VampireSorcerer extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    @Override
    public boolean upgradeResummonWhileSummoned(AbstractCard resummoningCard) { return true; }
