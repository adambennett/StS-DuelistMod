...
public class GhostrickRenovation extends DuelistCard 
{
    // TEXT DECLARATION
    ...
    {
    	ArrayList<AbstractCard> mutateFrom = new ArrayList<>();
    	mutateFrom.addAll(p.drawPile.group);
    	mutateFrom.addAll(p.discardPile.group);
    	mutateFrom.addAll(p.hand.group);
    	fullMutation(mutateFrom, mutateFrom.size(), 3, true, true);
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new GhostrickRenovation();
    }
