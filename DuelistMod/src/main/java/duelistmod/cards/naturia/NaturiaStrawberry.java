...
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("NaturiaStrawberry");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makePath(Strings.NATURIA_STRAWBERRY);
