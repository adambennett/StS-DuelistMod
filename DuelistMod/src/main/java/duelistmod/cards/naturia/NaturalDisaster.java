...
public class NaturalDisaster extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("NaturalDisaster");
	...
	@Override
    public AbstractCard makeCopy() { return new NaturalDisaster(); }
