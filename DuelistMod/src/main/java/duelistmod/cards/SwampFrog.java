...
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("SwampFrog");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("SwampFrog.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	if (roll == 1) { AbstractDungeon.actionManager.addToBottom(new ModifyBlockAction(this.uuid, DuelistMod.aquaTidalBoost)); }
