...
public class AttackMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("AttackMetronome");
