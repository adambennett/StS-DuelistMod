...
public class CombatMetronome extends MetronomeCard 
{
    // TEXT DECLARATION
    ...
    private ArrayList<AbstractCard> generate(int amtNeeded)
    {
		...
		for (AbstractCard c : DuelistMod.metronomeResummonsThisCombat)
		{
