...
import duelistmod.powers.duelistPowers.InfernityDoomPower;
import duelistmod.variables.Tags;

public class InfernityDoomDragon extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("InfernityDoomDragon");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("InfernityDoomDragon.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	tribute();
    	attack(m);
    	applyPowerToSelf(new InfernityDoomPower());
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new InfernityDoomDragon();
    }
