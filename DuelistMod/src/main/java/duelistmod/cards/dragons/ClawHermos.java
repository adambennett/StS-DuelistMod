...
import duelistmod.actions.unique.ClawHermosAction;
import duelistmod.helpers.Util;
import duelistmod.patches.AbstractCardEnum;
import duelistmod.powers.*;
import duelistmod.variables.Tags;

public class ClawHermos extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("ClawHermos");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("ClawHermos.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	for (AbstractCard c : p.drawPile.group) { if (c.hasTag(Tags.DRAGON)) { dragonCards.add(c); }}
    	this.addToBot(new ClawHermosAction(dragonCards, 1, this.magicNumber));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new ClawHermos();
    }
