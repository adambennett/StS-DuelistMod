...
import duelistmod.powers.duelistPowers.LostWorldPower;
import duelistmod.variables.Tags;

public class LostWorld extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("LostWorld");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("LostWorld.png");
    ...
    {
    	applyPowerToSelf(new LostWorldPower(this.magicNumber));
    }
