...
public class HymnOfLight extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("HymnOfLight");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("HymnOfLight.png");
    ...
    public HymnOfLight() {
        ...
        this.cardsToPreview = new MessengerPeace();
    ...
    {
    	this.addToBot(new MakeTempCardInDrawPileAction(new MessengerPeace(), 1, true, true));
    }

    // Which card to return when making a copy of this card.
    @Override
    public AbstractCard makeCopy() {
        return new HymnOfLight();
    }
