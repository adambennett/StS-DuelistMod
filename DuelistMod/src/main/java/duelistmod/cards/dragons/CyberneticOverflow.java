...
public class CyberneticOverflow extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CyberneticOverflow");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("CyberneticOverflow.png");
    ...
    {
    	applyPowerToSelf(new CyberneticOverflowDebuffA());
    	applyPowerToSelf(new CyberneticOverflowDebuffB());
