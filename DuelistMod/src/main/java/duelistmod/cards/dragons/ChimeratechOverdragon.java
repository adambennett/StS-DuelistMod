...
public class ChimeratechOverdragon extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("ChimeratechOverdragon");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("ChimeratechOverdragon.png");
    ...
    public AbstractCard makeCopy() {
        return new ChimeratechOverdragon();
    }
