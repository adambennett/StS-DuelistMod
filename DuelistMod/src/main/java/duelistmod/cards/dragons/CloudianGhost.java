...
public class CloudianGhost extends DuelistCard 
{
    // TEXT DECLARATION
    public static final String ID = DuelistMod.makeID("CloudianGhost");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DuelistMod.makeCardPath("CloudianGhost.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	{
    		int totalDebuffs = 0;
    		for (AbstractPower pow : mon.powers) { if (pow.type.equals(PowerType.DEBUFF)) { totalDebuffs++; }}
    		if (totalDebuffs > 0) { applyPower(new PoisonPower(mon, p, totalDebuffs), mon); }
    	}
    }
