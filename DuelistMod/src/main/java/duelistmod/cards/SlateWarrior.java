...
{
	// TEXT DECLARATION
	public static final String ID = duelistmod.DuelistMod.makeID("SlateWarrior");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String IMG = DuelistMod.makePath(Strings.SLATE_WARRIOR);
