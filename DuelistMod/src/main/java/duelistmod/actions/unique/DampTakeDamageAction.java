...
public class DampTakeDamageAction extends AbstractGameAction
{
    public DampTakeDamageAction(final AbstractCreature target, final AbstractCreature source, final int amount, final AttackEffect effect) {
