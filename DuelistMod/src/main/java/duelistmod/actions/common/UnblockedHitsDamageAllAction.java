...
public class UnblockedHitsDamageAllAction extends AbstractGameAction
{
    public int[] damage;
    
    public UnblockedHitsDamageAllAction(final AbstractCreature source, final int[] amount, final DamageInfo.DamageType type, final AttackEffect effect) {
