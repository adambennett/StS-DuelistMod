...
public class FetchAndReduceAction extends AbstractGameAction
{
	...
	public FetchAndReduceAction(int amount, CardGroup source, int costReduce, int tribReduce, boolean combat)
	{
	...
	public FetchAndReduceAction(int amount, CardGroup source, int costReduce, boolean combat)
	{
		this(amount, source, costReduce, 0, combat);
	}
