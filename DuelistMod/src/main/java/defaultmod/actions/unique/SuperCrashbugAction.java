...
public class SuperCrashbugAction extends AbstractGameAction
{
	...
	public SuperCrashbugAction(int amount, DuelistCard callCard)
	{
	...
	public SuperCrashbugAction(int amount, AbstractMonster m, DuelistCard callCard)
	{
		this.p = AbstractDungeon.player;
		setValues(this.p, AbstractDungeon.player, amount);
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
	...
	public SuperCrashbugAction(int amount, boolean upgraded, AbstractMonster m, DuelistCard callCard)
	{
		this.p = AbstractDungeon.player;
		setValues(this.p, AbstractDungeon.player, amount);
		this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
	...
	public void update()
	{
		...
		if (this.duration == Settings.ACTION_DUR_MED) 
		{
			...
			{
				if (c.hasTag(DefaultMod.MONSTER) && !c.hasTag(DefaultMod.CRASHBUG))
				{
