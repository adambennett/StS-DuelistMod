	...
	public static String runAction(String string, boolean upgradeCards) 
	{
		...
		switch (string)
		{
			...
			case "Add #b1 random #ySpell to hand":
				...
				break;
			case "#yEvoke #b1 Orb":
				if (AbstractDungeon.player.orbs.size() < 1) { triggerRandomAction(1, upgradeCards); System.out.println("theDuelist:RandomActionHelper:runAction ---> triggered: Evoke 1 Orb, but skipped due to no orbs ");break; }
