...
public class UltimateOfferingPower extends AbstractPower 
{
    ...
    public static final String POWER_ID = DefaultMod.makeID("UltimateOfferingPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String IMG = DefaultMod.makePath(DefaultMod.ULTIMATE_OFFERING_POWER);
