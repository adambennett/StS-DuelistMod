...
public class RedEyes extends CustomCard {
    ...
    public static final String ID = defaultmod.DefaultMod.makeID("RedEyes");
    ...
    public static final String IMG = DefaultMod.makePath(DefaultMod.RED_EYES);
