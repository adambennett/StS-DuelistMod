...
public class Graverobber extends DuelistCard 
{
    ...
    public static final String IMG = DefaultMod.makePath(DefaultMod.GRAVEROBBER);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
		...
		for (DuelistCard c : DefaultMod.spellsThisRun) { drawPowers.add(c); }
		for (DuelistCard c : DefaultMod.trapsThisRun) { drawPowers.add(c); }
