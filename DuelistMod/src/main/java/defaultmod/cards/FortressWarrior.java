...
{
    // TEXT DECLARATION
    public static final String ID = defaultmod.DefaultMod.makeID("FortressWarrior");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.FORTRESS_WARRIOR);
