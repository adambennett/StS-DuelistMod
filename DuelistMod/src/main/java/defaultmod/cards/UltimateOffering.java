...
import defaultmod.powers.UltimateOfferingPower;

public class UltimateOffering extends DuelistCard 
{
    // TEXT DECLARATION 
    public static final String ID = DefaultMod.makeID("UltimateOffering");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.ULTIMATE_OFFERING);
