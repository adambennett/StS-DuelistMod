...
{
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID("ComicHand");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.COMIC_HAND);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) 
    {
    	...
    	{
    		if (DefaultMod.summonMap.get(s).hasTag(DefaultMod.TOON))
    		{
    			tokens++;
    		}
    		else
    	...
    	{
    		DuelistCard tempCard = (DuelistCard) returnTrulyRandomFromSet(DefaultMod.MONSTER);
