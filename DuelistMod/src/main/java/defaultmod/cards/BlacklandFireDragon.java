...
{
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID("BlacklandFireDragon");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.BLACKLAND_FIRE_DRAGON);
