...
{
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID("Firegrass");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.FIREGRASS);
    ...
    public Firegrass() {
        ...
        this.startingNatureDeckCopies = 2;
