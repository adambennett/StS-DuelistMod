...
{
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID("WhiteNightDragon");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.WHITE_NIGHT);
