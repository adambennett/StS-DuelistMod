...
{
	// FIELDS
	public static final String ID = DefaultMod.makeID("GiftAnubis");
    public static final String IMG = DefaultMod.makePath(DefaultMod.GIFT_ANUBIS_RELIC);
    public static final String OUTLINE = DefaultMod.makePath(DefaultMod.GIFT_ANUBIS_RELIC_OUTLINE);
    // /FIELDS
