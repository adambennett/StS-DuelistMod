...
public class StarterRelic extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = defaultmod.DefaultMod.makeID("StarterRelic");
    ...
    {
        this.flash();
        AbstractDungeon.actionManager.addToTop(new com.megacrit.cardcrawl.actions.common.ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new SummonPower(AbstractDungeon.player, 1), 1));
    }
