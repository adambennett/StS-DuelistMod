...
{
	public static final String ID = DefaultMod.makeID("Mist");
	...
	public Mist()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Mist.png"));
	...
	public void onEvoke()
	{
		...
		if (p.hasPower(SummonPower.POWER_ID))
		{
	    	...
	    	{
	    		if (DefaultMod.summonMap.get(s).hasTag(DefaultMod.AQUA))
	    		{
	    			tokens++;
	    		}
	    		else
	    	...
	    	{
	    		DuelistCard tempCard = (DuelistCard) DuelistCard.returnTrulyRandomFromSet(DefaultMod.MONSTER);
	...
	{
		DuelistCard randomAqua = (DuelistCard) DuelistCard.returnTrulyRandomFromSet(DefaultMod.AQUA);
