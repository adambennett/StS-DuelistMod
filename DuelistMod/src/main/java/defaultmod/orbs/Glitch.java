...
public class Glitch extends AbstractOrb
{
	...
	public Glitch()
	{
		...
		evokeActions.add("Draw #b2 cards");	evokeActions.add("Gain #b10 HP");
		evokeActions.add("Gain a random amount of gold (50-100)");
		evokeActions.add("Apply #b1 random #ybuff");	evokeActions.add("Apply #b1 random #ydebuff to random enemy");	evokeActions.add("#yChannel #b1 random orb");
		evokeActions.add("#yEvoke #b1 Orb.");	evokeActions.add("Add #b1 random #ySpell to hand");
		evokeActions.add("Add #b1 random #yTrap to hand");	evokeActions.add("Add #b1 random #ySpellcaster to hand");	evokeActions.add("Add #b1 random #yMonster to hand");
