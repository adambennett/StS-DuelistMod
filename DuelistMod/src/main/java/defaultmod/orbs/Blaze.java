...
{
	public static final String ID = DefaultMod.makeID("Blaze");
	...
	public Blaze()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Blaze.png"));
	...
	{
		applyFocus();
		DuelistCard.heal(AbstractDungeon.player, this.evokeAmount * DefaultMod.summonCombatCount);
	}
	...
	{
		DuelistCard.heal(AbstractDungeon.player, this.passiveAmount * DefaultMod.summonCombatCount);
	}
