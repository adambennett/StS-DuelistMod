...
{
	public static final String ID = DefaultMod.makeID("Gadget");
	...
	public Gadget()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Gadget.png"));
	...
	{
		applyFocus();
		if (DefaultMod.trapsThisRun.size() > 0)
		{
			DuelistCard randomTrap = DefaultMod.trapsThisRun.get(AbstractDungeon.cardRandomRng.random(DefaultMod.trapsThisRun.size() - 1));
			if (!randomTrap.tags.contains(DefaultMod.TRIBUTE)) { randomTrap.misc = 52; }
	...
	public void triggerPassiveEffect()
	{
		...
		AbstractDungeon.actionManager.addToTop(new RandomizedAction(randomTrap, false, true, true, true, false, false, false, false, this.passiveAmount - 1, this.passiveAmount, 0, 0, 0, 0));
	}
