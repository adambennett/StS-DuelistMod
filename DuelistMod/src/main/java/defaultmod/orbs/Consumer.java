...
{
	public static final String ID = DefaultMod.makeID("Consumer");
	...
	public Consumer()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Consumer.png"));
	...
	public void onEvoke()
	{
		...
		DefaultMod.resetRandomBuffs(tribs);
