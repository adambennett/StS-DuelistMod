...
public class Summoner extends AbstractOrb
{
	public static final String ID = defaultmod.DefaultMod.makeID("Summoner");
	...
	public Summoner()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Summoner.png"));
