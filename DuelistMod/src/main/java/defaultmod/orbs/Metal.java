...
{
	public static final String ID = DefaultMod.makeID("Metal");
	...
	public Metal()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Metal.png"));
	...
	{
		int spells = DefaultMod.spellCombatCount;
