...
{
	public static final String ID = DefaultMod.makeID("Mud");
	...
	public Mud()
	{
		this.img = ImageMaster.loadImage(DefaultMod.makePath("orbs/Mud.png"));
	...
	{
		DuelistCard randomNature = (DuelistCard) DuelistCard.returnTrulyRandomFromEitherSet(DefaultMod.PLANT, DefaultMod.INSECT);
